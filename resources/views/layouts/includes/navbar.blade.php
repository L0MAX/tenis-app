<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="  {{ route('home')}}" class="brand-link">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('choose.opponent')}}">
                    ...
                    <span class="nav-link-text ms-1">Choose Partner</span>
                </a>
            </li>
            @else
            ...
            @endif
            <li class="nav-item">
                <a class="nav-link text-white " href="{{route('my.fixture')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
